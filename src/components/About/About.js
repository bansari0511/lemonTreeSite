  ...
  return (
    <section name='about' className='about'>
      <div className='about-container'>
        ...
        <h2 className='about-subtitle'>New Delhi</h2>
        <p className='about-text'>
          Little Lemon is owned by two Gujaratis, Kamle and Chintan, who
          moved to the New Delhi to pursue their shared dream of owning a
          restaurant. <br />
          <br />
