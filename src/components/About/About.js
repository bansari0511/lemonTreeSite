    ...
    <section name='about' className='about'>
      <div className='about-container'>
        ...
        <p className='about-text'  >
          Little Lemon is owned by Mark and Thomas , who
          moved to the Chicago to pursue their shared dream of owning a
          restaurant. <br />
          <br />
          To craft the menu, Mark relies on family recipes and his experience as chef 
          in Italy. Thomas does all the marketing for the restaurant
